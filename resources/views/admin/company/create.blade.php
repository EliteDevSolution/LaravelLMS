        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active"> {{ trans('global.create') }} {{ trans('cruds.company.title_singular') }} </li>
                </ol>
            </div>
            <h4 class="page-title"> {{ trans('global.create') }} {{ trans('cruds.company.title_singular') }} </h4>
        </div>
    </div>
</div>
<div class="card">
