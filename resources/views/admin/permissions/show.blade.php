        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active"> {{ trans('global.show') }} {{ trans('cruds.permission.title') }} </li>
                </ol>
            </div>
            <h4 class="page-title"> {{ trans('global.show') }} {{ trans('cruds.permission.title') }} </h4>
        </div>
    </div>
</div>
<div class="card">
